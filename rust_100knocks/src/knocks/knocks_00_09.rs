...
pub fn knock_08(a: &str) -> Option<String> {
    match a.parse::<i32>() {
        Ok(n) => if n > 0 { 
                    Some(String::from("positive")) 
                 } else { 
                    None 
                },
        // 間違い: ParseIntError => None
        Err(_) => None 
    }
}
...
pub fn knock_09(a: &str) -> String {
    match a.parse::<i32>() {
        ...
        // 間違い: ParseIntError => String::from("ParseIntError")
